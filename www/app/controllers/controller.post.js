angular.module('module.view.post', [])
	.controller('postCtrl', function($scope,$rootScope,$state,postService,$ionicHistory,$ionicPopup,$cordovaSocialSharing,postService,engagementsService,$stateParams) {
